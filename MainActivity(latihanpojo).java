        ...
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                Intent moveWithDataIntent = new Intent(MainActivity.this,MoveWithDataActivity.class);
                    moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Virgiawan Dejan");
                    moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                        startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                    mPerson.setName("Virgiawan Dejan");
                    mPerson.setAge(17);
                    mPerson.setEmail("1819117672.siswa@smkn4bdg.sch.id");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "081572213601";
